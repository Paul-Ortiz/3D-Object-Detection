...
def detect_objects(input_bev_maps, model, configs):
    ...
    if len(detections) > 0:
        ...
        for obj in detections:
            ...
            img_x = bev_y / configs.bev_height * (configs.lim_x[1] - configs.lim_x[0]) + configs.lim_x[0] 
            img_y = bev_x / configs.bev_width * (configs.lim_y[1] - configs.lim_y[0]) + configs.lim_y[0]
            z = z + configs.lim_z[0]
